 ...
 *
 */ 
public final class JodaLocalDateConverter extends Converter {
    ...
    private static final ArgumentsTypeScheme ATS_JAVAUTILDATE_EMPTY = 
        new ArgumentsTypeScheme(
            ...
            TypeSchemes.EMPTY_TYPESCHEME, 
                "The given java.util.Date is converted into a LocalDate. Any information about the time will be lost in the result.");
    private static final ArgumentsTypeScheme ATS_JAVAUTILDATE_DATETIMEZONE = 
        new ArgumentsTypeScheme(
            TypeSchemes.JAVAUTILDATE_TYPESCHEME, 
            TypeSchemes.forName("org.joda.time.DateTimeZone"),
                "The given java.util.Date is converted into a LocalDate configured with the given" +
                " DateTimeZone.  Any information about the time will be lost in the result.");
    private static final ArgumentsTypeScheme ATS_JAVAUTILDATE_CHRONOLOGY = 
        new ArgumentsTypeScheme(
            TypeSchemes.JAVAUTILDATE_TYPESCHEME, 
            TypeSchemes.forName("org.joda.time.Chronology"), 
                "The given java.util.Date is converted into a LocalDate with the given Chronology. " +
                " Any information about the time will be lost in the result.");
    
    private static final ArgumentsTypeScheme ATS_JAVASQLDATE_EMPTY = 
        new ArgumentsTypeScheme(
            TypeSchemes.JAVASQLDATE_TYPESCHEME, 
            TypeSchemes.EMPTY_TYPESCHEME, 
                "The given java.sql.Date is converted into a LocalDate. Any information about the time will be lost in the result.");
    private static final ArgumentsTypeScheme ATS_JAVASQLDATE_DATETIMEZONE = 
        new ArgumentsTypeScheme(
            TypeSchemes.JAVASQLDATE_TYPESCHEME, 
            TypeSchemes.forName("org.joda.time.DateTimeZone"), 
                "The given java.sql.Date is converted into a LocalDate with the given DateTimeZone." +
                " Any information about the time will be lost in the result.");
    private static final ArgumentsTypeScheme ATS_JAVASQLDATE_CHRONOLOGY= 
        new ArgumentsTypeScheme(
            TypeSchemes.JAVASQLDATE_TYPESCHEME, 
            TypeSchemes.forName("org.joda.time.Chronology"),
                "The given java.sql.Date is converted into a LocalDate with the given Chronology." +
                " Any information about the time will be lost in the result.");
    ...
    private static final ArgumentsTypeScheme ATS_TIMESTAMP_EMPTY = 
        new ArgumentsTypeScheme(
            ...
            TypeSchemes.EMPTY_TYPESCHEME, 
                "The given java.sql.Timestamp is converted into a LocalDate." +
                " Any information about the time will be lost in the result.");
    private static final ArgumentsTypeScheme ATS_TIMESTAMP_DATETIMEZONE = 
        new ArgumentsTypeScheme(
            TypeSchemes.TIMESTAMP_TYPESCHEME, 
            TypeSchemes.forName("org.joda.time.DateTimeZone"), 
                "The given java.sql.Timestamp is converted into a LocalDate in the given DateTimeZone." +
                " Any information about the time will be lost in the result.");
    private static final ArgumentsTypeScheme ATS_TIMESTAMP_CHRONOLOGY = 
        new ArgumentsTypeScheme(
            TypeSchemes.TIMESTAMP_TYPESCHEME, 
            TypeSchemes.forName("org.joda.time.Chronology"),
                "The given java.sql.Timestamp is converted into a LocalDate with the given Chronology." +
                " Any information about the time will be lost in the result.");
    ...
    private static final ArgumentsTypeScheme ATS_LONG_EMPTY = 
        new ArgumentsTypeScheme(
            ...
            TypeSchemes.EMPTY_TYPESCHEME, 
                "The given long representing the time in millis is converted into a LocalDate." +
                " Any information about the time will be lost in the result.");
    private static final ArgumentsTypeScheme ATS_LONG_DATETIMEZONE = 
        new ArgumentsTypeScheme(
            TypeSchemes.LONG_TYPESCHEME, 
            TypeSchemes.forName("org.joda.time.DateTimeZone"),
                "The given long representing the time in millis is converted into a LocalDate in the" +
                " given DateTimeZone. Any information about the time will be lost in the result.");
    private static final ArgumentsTypeScheme ATS_LONG_CHRONOLOGY = 
        new ArgumentsTypeScheme(
            TypeSchemes.LONG_TYPESCHEME, 
            TypeSchemes.forName("org.joda.time.Chronology"),
                "The given long representing the time in millis is converted into a LocalDate with the" +
                " given Chronology. Any information about the time will be lost in the result.");
    ...
    private static final ArgumentsTypeScheme ATS_STRINGYEAR_STRINGMONTH_STRINGDAY_DATETIMEZONE = 
        new ArgumentsTypeScheme(
            ...
            TypeSchemes.forName("org.joda.time.DateTimeZone"),
                "A LocalDate is created from the given year, month and day." +
                " The LocalDate will be created with the given DateTimeZone");
    ...
    private static final ArgumentsTypeScheme ATS_CALENDAR_EMPTY = 
        new ArgumentsTypeScheme(
            ...
            TypeSchemes.EMPTY_TYPESCHEME, 
                "It converts a Calendar into a LocalDate. Any information about the time will be lost in the result.");
    ...
    public Type getResultType() {
        return Types.forName("org.joda.time.LocalDate");
    }
	...
	protected Result doExecute(final Arguments arguments) throws Exception {
		...
		if (ATS_CALENDAR_EMPTY.matches(arguments)) {
			return createUniqResult(new LocalDate((Calendar) arguments.getTarget(0)));
		}
    ...
    private LocalDate fromString(final String asString, final String pattern, final Locale locale,
		...
		result = dateTimeFormatter.parseDateTime(asString).toLocalDate();
		
		return result;		
	}
		
	private LocalDate fromLong(final long asLong, final DateTimeZone dateTimeZone, final Chronology chronology) 
		throws Exception {

		Validate.isTrue(!((dateTimeZone != null) && (chronology != null)));
		
		if (dateTimeZone != null) {
			return new LocalDate(asLong, dateTimeZone);
		}
		if (chronology != null) {
			return new LocalDate(asLong, chronology);
		}
		
		return new LocalDate(asLong);
	}
	
	private LocalDate fromInts(final Integer year, final Integer month, final Integer day,
        ...
        if (dateTimeZone != null) {
        	return new DateMidnight(year.intValue(), month.intValue(),
    	    		day.intValue(), dateTimeZone).toLocalDate();
        }
        if (chronology != null) {
        	return new LocalDate(year.intValue(), month.intValue(),
